...
interface UserData {
  ...
  stage?: string;      // Added to reflect user stage updates
}
...
export default function RejectPage() {
  ...
  // Destructure the id from params and enforce it as string
  ...
  const handleDashboardRedirect = async () => {
    ...
    try {
      ...
      await updateDoc(userRef, { stage: "rejected" });
  ...
  return (
    <div className="p-6">
      ...
      <p className="text-lg mb-6">
        Thank you for submitting your certification details. After reviewing your documents, we regret to inform you
        that your application does not currently meet the requirements to become an instructor on our platform.
      </p>
      
      <p className="text-lg mb-6">
        We understand that this may be disappointing. To better assist you, we recommend reaching out to our support
        team to clarify any specific concerns or resolve the issue. They will be happy to guide you through the next
        steps or answer any questions you may have.
      </p>
      
      <p className="text-lg mb-6">You can contact us by:</p>
      <ul className="mb-6">
